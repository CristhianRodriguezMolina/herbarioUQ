...
@NamedQueries({
		...
		@NamedQuery(name = Recolector.LISTAR_PLANTAS_ACEPTADAS_POR_FAMILIA, query = "select planta from Planta planta where planta.genero.familia.familia=:familia and planta.registro.aprovacion= 1"),
		@NamedQuery(name = Recolector.LISTAR_PLANTAS_POR_GENERO, query = "select planta from Planta planta where planta.genero.genero=:genero and planta.registro.aprovacion= 1"), })
